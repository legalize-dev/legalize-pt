---
title: "Decreto Regulamentar Regional n.º 9/91/A — Aprova a orgânica do Instituto de Gestão de Regimes de Segurança Social (IGRSS)"
identifier: "DRE-1991-9-458870"
country: "pt"
rank: "decreto-regulamentar-regional"
publication_date: "1991-03-07"
last_updated: "1992-04-03"
status: "partially_repealed"
source: "https://data.dre.pt/eli/decregulreg/9/1991/03/07/a/dre/pt/html"
text_state: "as_enacted"
last_amendment: "DRE-1992-23-523400"
department: "Região Autónoma dos Açores - Governo Regional - Secretaria Regional da Saúde e Segurança Social"
jurisdiction: "pt-20"
pdf_url: "https://files.diariodarepublica.pt/1s/1991/03/055b00/11711193.pdf"
subjects: ["Orgânica", "Quadro de Pessoal", "Instituto de Gestão de Regimes de Segurança Social", "Açores"]
summary: "Aprova a orgânica do Instituto de Gestão de Regimes de Segurança Social (IGRSS)"
short_title: "Aprova a orgânica do Instituto de Gestão de Regimes de Segurança Social (IGRSS)"
official_number: "9/91/A"
eli: "https://data.dre.pt/eli/decregulreg/9/1991/03/07/a/dre/pt/html"
...
dre_id: "458870"
dre_link: "/dr/detalhe/decreto-regulamentar-regional/9-1991-458870"
...
O [Decreto Legislativo Regional n.º 11/87/A](https://diariodarepublica.pt/dr/detalhe/decreto-legislativo-regional/11-1987-419795), de 26 de Junho, determinou a criação do Instituto de Gestão de Regimes de Segurança Social, integrando num único organismo os actuais centros de prestações pecuniárias de segurança social e o Núcleo Coordenador de Prestações Diferidas.
...
e) Centro Coordenador de Prestações Diferidas;

f) Centro de Prestações Pecuniárias de Angra do Heroísmo;

g) Centro de Prestações Pecuniárias da Horta;

h) Centro de Prestações Pecuniárias de Ponta Delgada.
...
d) Dirigir os serviços colocados na sua dependência directa.
...
c) Elaborar as estatísticas financeiras;

d) Elaborar indicadores de gestão;

e) Efectuar o controlo orçamental;

f) Elaborar relatórios da cobrança de contribuições em dívida;

g) Emitir parecer sobre os acordos para pagamento de dívidas em prestações;

h) Propor acções tendentes a prevenir e contrariar as situações contributivas devedoras;

i) Assegurar as operações relativas à contabilidade e tesouraria;

j) Elaborar os mapas e documentos complementares necessários ao controlo de legalidade das contas;

l) Apoiar tecnicamente o Centro Coordenador de Prestações Diferidas e os centros de prestações pecuniárias em matéria de orçamento e contabilidade.
...
i) Apoiar tecnicamente o Centro Coordenador de Prestações Diferidas e os centros de prestações pecuniárias.
...
a) Responder às reclamações dos utentes, em articulação com os serviços competentes do centro;

b) Colaborar com o Serviço de Apoio Técnico na criação do serviço de informação ao público;

c) Propor medidas de aperfeiçoamento do atendimento dos utentes;

d) Centralizar os contactos com os meios de comunicação social no que diz respeito à divulgação de medidas de gestão e programas de acção com interesse para o público.
...
a) Coordenação Geral de Prestações Diferidas do Regime Geral;

b) Coordenação Geral de Prestações Diferidas de Regimes Especiais e Administração;
...
e) Executar as tarefas necessárias à passagem dos arquivos tradicionais a microfilmados, produzir as microformas e garantir a sua conservação e fácil consulta;
...
a) Elaborar indicadores sobre o funcionamento do CCPD com base, nomeadamente, no tratamento de informações, sugestões e reclamações recebidas, com vista à permanente melhoria da prestação de serviços;

b) Realizar campanhas de esclarecimento junto dos beneficiários, utentes, contribuintes e público em geral, com vista à divulgação de informação sobre o sistema de segurança social e sobre o CCPD em particular;
...
f) Organizar e manter actualizados ficheiros de legislação, jurisprudência e doutrina sobre matérias de interesse para o CCPD e efectuar a difusão interna dos diplomas legais e outros elementos;

g) Receber e tratar os dados estatísticos do sector;

h) Executar a acção contenciosa;

i) Organizar os processos de contra-ordenações.
...
b) Divisão de Serviços Desconcentrados e Fiscalização;

c) Repartição de Administração;

d) Coordenação de Contabilidade;

e) Centro de Informática;

f) Serviço de Apoio Técnico.
...
g) Preprar as autorizações de recebimento e de pagamento;
...
a) Elaborar indicadores sobre o funcionamento do CPPAH com base, nomeadamente, no tratamento de informações, sugestões e reclamações recebidas, com vista à permanente melhoria da prestação de serviços;

b) Realizar campanhas de esclarecimento junto dos beneficiários, utentes, contribuintes e público em geral, com vista à divulgação de informação sobre o sistema de segurança social e sobre o CPPAH em particular;
...
f) Organizar e manter actualizados ficheiros de legislação, jurisprudência e doutrina sobre matérias de interesse para o CPPAH e efectuar a difusão interna dos diplomas legais e outros elementos;
...
c) Comprovar e controlar a situação das entidades, designadamente no que respeita a datas de início, suspensão ou cessação da actividade;
...
h) Assegurar o envio de elementos relativos ao registo de remunerações a outros serviços públicos que deles careçam e aos beneficiários.
...
c) Coordenação Concelhia de Lajes do Pico;
...
b) Divisão de Coordenação de Serviços Desconcentrados e Fiscalização;

c) Repartição de Administração;

d) Coordenação Geral de Contabilidade;
...
a) Receber, expedir, registar, protocolar, classificar e distribuir a correspondência, documentos e meios de pagamento;
...
e) Assegurar os procedimentos referentes à administração de pessoal;
...
g) Realizar pequenos trabalhos de conservação, reparação e outros que possam sser efectuados pelo pessoal operário e auxiliar;
...
h) Velar pela segurança e privacidade da informação a sua guarda.
...
a) Técnico auxiliar de segurança social de 1.ª classe, principal e especialista, respectivamente das categorias de técnico auxiliar de 2.ª classe, de 1.ª classe e principal, com um mínimo de três anos na respectiva categoria, classificados de Bom;

b) Coordenador e coordenador geral, respectivamente das categorias de especialista e coordenador, com um mínimo de três anos, classificados de Muito bom, ou cinco anos, classificados de Bom.
...
###### Artigo 108.º — Pessoal abrangido pela [Portaria n.º 193/79](https://diariodarepublica.pt/dr/detalhe/portaria/193-1979-382621), de 21 de Abril
...
[([ver documento original](https://files.diariodarepublica.pt/1s/1991/03/055b00/11711193.pdf))](https://files.diariodarepublica.pt/1s/1991/03/055b00/11711193.pdf)
