...
2 - A isenção referida no número anterior confere direito a dedução do imposto que eventualmente tenha onerado as aquisições dos respectivos bens e venha expresso na factura ou documento equivalente.
...
1 - As facturas ou documentos equivalentes, emitidos pelos sujeitos passivos revendedores, relativos às transmissões efectuadas ao abrigo do regime especial de tributação da margem, não podem discriminar o imposto devido e devem conter a menção «IVA - Bens em segunda mão» ou «IVA - Objectos de arte, de colecção ou antiguidades», conforme os casos.
