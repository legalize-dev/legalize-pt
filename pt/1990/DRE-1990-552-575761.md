---
title: "Portaria n.º 552/90 — Homologa as condições de aprovisionamento ao Estado na área de fotocopiadoras, duplicadores e gravadores de matrizes e…"
identifier: "DRE-1990-552-575761"
country: "pt"
rank: "portaria"
publication_date: "1990-07-17"
last_updated: "1990-07-17"
status: "in_force"
source: "https://diariodarepublica.pt/dr/detalhe/portaria/552-1990-575761"
text_state: "as_enacted"
department: "Ministério das Finanças"
pdf_url: "https://files.diariodarepublica.pt/1s/1990/07/16300/29762981.pdf"
...
dre_id: "575761"
dre_link: "/dr/detalhe/portaria/552-1990-575761"
---
# Portaria n.º 552/90 — Homologa as condições de aprovisionamento ao Estado na área de fotocopiadoras, duplicadores e gravadores de matrizes e…
...
7.º A presente portaria entra em vigor no dia 1 de Julho de 1990.
...
[([ver documento original](https://files.diariodarepublica.pt/1s/1990/07/16300/29762981.pdf))](https://files.diariodarepublica.pt/1s/1990/07/16300/29762981.pdf)
...
1 - Entende-se por serviços de manutenção preventiva os realizados com a regularidade necessária para reduzir os riscos de avaria do material ou de degradação do serviço prestado, por forma a garantir no tempo as respectivas características a um nível o mais aproximado possível das iniciais.
...
d) Substituição temporária, no todo ou em parte, do material, quando haja lugar à sua inopercaionalidade por período superior a oito dias úteis.
...
3 - Sempre que os serviços de manutenção sejam da iniciativa do fornecedor, este deverá informar, com a antecedência mínima de 24 horas, o responsável pela gestão do material da data e hora da respectiva realização.
...
c) Operações de manutenção preventiva e correctiva efectuadas, incluindo as peças substituídas;

d) Registo do total do número de cópias A4 assinaladas no contador/totalizador naquela data.
...
2 - As prestações anuais incluem todos os impostos que incidam sobre o objecto do contrato, sendo as relativas ao 2.º ano e seguintes calculadas com base no valor de ______$__ (P(índice 1)), podendo ser amortizadas trimestralmente.

3 - A prestação anual efectivamente a pagar no 2.º ano e seguintes será determinada pela seguinte fórmula:

P(índice n) = P(índice m - 1) (1 + T(índice m - 1))

sendo:

n - ano de validade do contrato a que se reporta a prestação;

T(índice m - 1) - taxa oficial de inflação calculada pelo Instituto Nacional de Estatística reportada ao mês de Dezembro que ocorre no ano anterior àquele a que se refere a prestação.

4 - As prestação anuais calculadas de acordo com o disposto nos n.os 2 e 3 são válidas até ao limite de ... cópias por ano.

5 - As cópias que, em cada ano, excedam o limite estabelecido no número 4 serão debitadas com base no valor de ______$__ (C(índice 1)) por cópia.
...
c) Utilização de peças, consumíveis e equipamento opcional directamente relacionado com o funcionamento do material que não sejam originárias do fornecedor;
