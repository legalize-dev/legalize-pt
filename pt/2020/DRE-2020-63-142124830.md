...
2 - As regras legais aplicáveis às sociedades financeiras aplicam-se ao recrutamento, seleção e avaliação dos membros do órgão de administração do BPF, especificamente no respeitante a requisitos de adequação previstos no RGICSF, bem como as normas legais aplicáveis aos gestores públicos, em especial as previstas no Estatuto do Gestor Público, aprovado pelo Decreto-Lei n.º 71/2007, de 27 de março, na sua redação atual (EGP).
