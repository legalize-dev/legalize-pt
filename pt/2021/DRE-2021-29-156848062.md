...
5 - No caso das alíneas b), c), d), q), r) e s), existindo mais do que uma associação representativa, a notificação é remetida para todas para que, de forma conjunta, indiquem um único representante da respetiva atividade.
