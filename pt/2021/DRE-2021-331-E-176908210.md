...
e) «Refeições prontas a consumir, no regime de pronto a comer e levar ou com entrega ao domicílio» os pratos ou alimentos, incluindo bebidas, preparados para consumo imediato sem necessidade de preparação suplementar, disponibilizados para consumo fora do local ou estabelecimento através de uma operação de transmissão de bens, a levar pelo cliente ou com entrega ao domicílio.
...
2 - A contribuição sobre as embalagens de utilização única aplica-se a partir de 1 de julho de 2022, para as embalagens de plástico ou multimaterial com plástico, e a partir de 1 de janeiro de 2023, para as embalagens de alumínio ou multimaterial com alumínio.
