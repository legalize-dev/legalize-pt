...
1 - O consentimento dos pais pode ser prestado independentemente da instauração de processo de adopção nos casos previstos no Código Civil; para tanto, devem os pais requerer ao tribunal a designação de dia para o prestarem, observando-se, com as necessárias adaptações, o disposto no artigo 164.º
