...
5 - A relação entre as taxas de portagem das classes 4 e 1 não poderá ser superior a 5.

6 - As taxas de portagem, a cobrar na actual travessia a partir de 1996 e a cobrar na nova travessia a partir da data de entrada em serviço, serão as fixadas no segundo contrato de concessão.

7 - Até à entrega da sua exploração, a determinação das taxas de portagem a cobrar na actual travessia será da exclusiva competência do concedente.

8 - A concessionária apenas poderá não cobrar portagens com prévia autorização do concedente, excepto em casos de manifesta urgência ou quando tal resultar de imposição de autoridade com poderes de disciplina de tráfego.

9 - As taxas de portagem serão cobradas apenas no sentido de tráfego sul-norte.
