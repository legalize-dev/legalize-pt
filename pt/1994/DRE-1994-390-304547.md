...
2.º escalão - pressão de serviço igual ou inferior a 20 b e superior a 4 b.
...
1 - As pressões máxima e mínima do ensaio em fábrica, expressas em bars, correspondendo respectivamente às tensões limite, são determinadas pela forma indicada no quadro seguinte:
...
1 - O limite máximo da pressão de prova hidráulica é e 210 b e visa apenas o controlo de fabrico.
...
P = pressão de cálculo, expressa em bars;
...
4 - O valor máximo da pressão de serviço não deve, sem caso algum, ultrapassar o valor da pressão de cálculo.
...
a) Se no momento da realização do ensaio de resistência, a temperatura do solo à profundidade da tubagem for inferior ou igual a 0ºC ou puder baixar até esse nível do fim do ensaio ou ainda se não se dispuser de água em quantidade e qualidade convenientes;
...
a) A que tem por objectivo a detenção de danos causados por terceiros - tipo A -, a qual pode ser efectuada por meios aéreos, veículos terrestres ou a pé.

b) A que tem por objectivo a detenção de possíveis anomalias - tipo B -, a qual deve ser feita a pé.
