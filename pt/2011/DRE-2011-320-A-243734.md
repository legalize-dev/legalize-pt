...
1 - A Direção de Serviços do Imposto Municipal sobre Imóveis, abreviadamente designada por DSIMI, executa os procedimentos relativos à gestão do imposto municipal sobre imóveis (IMI).
...
###### Artigo 16.º — Direção de Serviços de Cobrança
...
f) Recolher, sistematizar e analisar indicadores de controlo da eficácia da execução fiscal e prever a respetiva evolução;
...
###### Artigo 33.º — Direção de Serviços de Comunicação e Apoio ao Contribuinte
