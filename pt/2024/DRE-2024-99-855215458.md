...
| Sala de apoio | Apoio aos tratamentos | 9 para3 boxes | 2,6 | Facultativa, exceto para serviços organizados em boxes. Considerar um acréscimo de 1 m<sup>2</sup> por cada box adicional. |
...
| Sujos e despejos | Para arrumação temporária de sacos de roupa suja e de resíduos, de material de limpeza e despejos | – | – | A área prevista deve garantir a funcionalidade da sala, considerando o volume de sujos e tempo de permanência.Deve ser garantida a separação física entre o material de limpeza e os sujos. |
...
| Sala de reprocessamentoZona limpa | Com esterilizador de tipo adequado e ligação à zona de descontaminação por guichet ou por máquina de lavar com duas portas | – | – | c) |
...
| Sujos e despejos | Sistema de desinfeção de mãos, preferencialmente lavatório com torneira de comando não manual. |
| Sala de reprocessamentoSala de descontaminação | d) |
...
|  | Scanner intraoral | 1 |
|  | Aparelho de ortopantomografia/CBCT | 1 |
