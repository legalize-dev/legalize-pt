...
###### Artigo 5.º — Instrução e aplicação de sanções
...
1 - O produto das coimas aplicadas nos processos de contra-ordenação cuja competência para a instrução e decisão seja, nos termos do artigo anterior, da ASAE e da CACMEP, respectivamente, é distribuído da seguinte forma:
...
4 - Os médicos veterinários municipais devem remeter às direcções regionais de agricultura (DRA), pelo menos uma vez por ano, um relatório onde conste o número de locais licenciados e inspeccionados e as principais deficiências ou desconformidades detectadas.
