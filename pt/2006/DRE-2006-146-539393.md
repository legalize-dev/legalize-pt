...
1 - Os valores dos indicadores de ruído L(índice den) e L(índice n) são determinados pelos métodos de avaliação definidos nos n.os 2 e 3 do anexo II do presente decreto-lei, do qual faz parte integrante, até à adopção de métodos comuns de avaliação pela Comissão Europeia.
