...
1 - Os administradores são designados por Resolução do Conselho de Ministros, no caso do ML, e por deliberação em reunião da assembleia geral, no caso da Carris.
2 - A designação dos administradores implica a imediata cessação do mandato dos membros dos conselhos de administração do ML e da Carris em exercício de funções àquela data.
