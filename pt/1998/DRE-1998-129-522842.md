...
4 - Nos instrumentos a que se referem os números anteriores, o objecto social não pode ser ampliado a actividades não contidas no objecto declarado no certificado de admissibilidade.

5 - O disposto nos números anteriores não prejudica a especificação ou restrição das actividades contidas no objecto declarado desde que estas não estejam reflectidas na denominação, nem as alterações de redacção que não envolvam a sua ampliação.
