---
title: "Portaria n.º 583-C/99 — Aprova o Regulamento de Tarifas do Instituto Portuário do Sul"
identifier: "DRE-1999-583-C-249059"
country: "pt"
rank: "portaria"
publication_date: "1999-07-31"
last_updated: "2000-11-09"
status: "in_force"
source: "https://data.dre.pt/eli/port/583-c/1999/07/31/p/dre/pt/html"
...
pdf_url: "https://files.diariodarepublica.pt/1s/1999/07/177b01/00230034.pdf"
subjects: ["Instituto Portuário", "Instituto Portuário do SUL", "Preço", "Regulamento"]
...
official_number: "583-C/99"
eli: "https://data.dre.pt/eli/port/583-c/1999/07/31/p/dre/pt/html"
eli_type: "port"
surface: "pub"
series: "I"
year: "1999"
...
gazette_number: "177"
pages: "4966-(23) a 4966-(34)"
in_force_raw: "VIGENTE"
dre_id: "249059"
dre_link: "/dr/detalhe/portaria/583-c-1999-249059"
...
subject_ids: "30225490 30225498 30229845 30231785"
cites: "http://data.dre.pt/eli/dec-lei/200/1998/07/10/p/dre"
cites_count: "1"
---
# Portaria n.º 583-C/99 — Aprova o Regulamento de Tarifas do Instituto Portuário do Sul
...
###### Artigo 2.º — Competência do IPS

Sem prejuízo das competências previstas no presente Regulamento, no Regulamento do Sistema Tarifário dos Portos Nacionais, adiante designado por RST, ou em legislação especial, compete ao conselho de administração do IPS deliberar, nomeadamente, sobre:
...
5 - Não haverá lugar à emissão de facturas para a cobrança de importâncias inferiores a uma importância a fixar pelo conselho de administração do IPS, sendo, nestes casos, as mesmas pagas através de factura-recibo ou documento equivalente, imediatamente após a prestação do serviço.
...
2 - A tarifa de uso do porto integra duas componentes, sendo uma aplicável aos navios e embarcações, adiante designada por TUP/navio, e outra aplicável à carga, adiante designada por TUP/carga:
...
[(ver quadro no documento original)](https://files.diariodarepublica.pt/1s/1999/07/177b01/00230034.pdf)
...
[(ver tabela no documento original)](https://files.diariodarepublica.pt/1s/1999/07/177b01/00230034.pdf)
...
11 - Às embarcações de tráfego fluvial ou local do tipo carga, passageiros, pesca ou rebocadores poderá ser cobrada TUP/navio em avença, por períodos indivisíveis de tempo TVi, em dias, cujo valor será igual a [(ver fórmula no documento original)](https://files.diariodarepublica.pt/1s/1999/07/177b01/00230034.pdf)
...
3 - A taxa a cobrar às embarcações e navios não armados para viagem, quando fundeados, será igual a [(ver fórmula no documento original)](https://files.diariodarepublica.pt/1s/1999/07/177b01/00230034.pdf)
...
[(ver fórmula no documento original)](https://files.diariodarepublica.pt/1s/1999/07/177b01/00230034.pdf)
...
1 - A requisição de serviços de pilotagem e as respectivas normas e condições de cancelamento e alteração serão regulamentadas pelo IPS.
...
2 - As taxas aplicáveis da redução RRA = 10%, caso os rebocadores se atrasem mais de (Tasr = 30 minutos) em relação à hora para que o serviço foi requisitado.

3 - A requisição do serviço de reboque deverá ser feita com a antecedência mínima de (Trsr = 3 horas), dentro do horário normal de funcionamento do porto.

4 - Se a chegada, partida ou manobra do navio for adiada ou cancelada e ou os rebocadores forem dispensados sem serem usados, sem aviso dado no mínimo com (Tcsr = 2 horas) antes da hora de começo constante do pedido inicial do serviço, será cobrada a taxa fixa cumulativa de cancelamento ou alteração TRC = 40000$00.
...
6 - Se o serviço não for iniciado até (Tlir = 45 minutos) após a hora para que foi solicitado ou até (Tlia = 30 minutos), no caso de assistência à largada, será cobrada uma taxa cumulativa por hora indivisível de espera, equivalente a (FRJ = 50%) das taxas REi, RMi, RFi ou RCi, de outro modo aplicável.

7 - Se o navio rebocado manobrar só com recurso à força de tracção de rebocadores, as taxas aplicáveis serão majoradas do factor FPj = 1,5.

8 - Se for necessária força de tracção extra devido a regras oficiais de segurança ou a pedido do comandante do navio, que possa ser satisfeito, será aplicada a tarifa de uso de equipamento.

9 - Se o navio for rebocado após garrar ou partir amarras, as taxas aplicáveis serão majoradas do factor FGJ = 2.
...
1 - Pela utilização de instalações portuárias é devida, por passageiro e por operação de embarque e desembarque, a taxa MP1 = 600$00.
...
3 - O pescado fresco proveniente de outras lotas que entre no porto por via marítima estará sujeito ao pagamento da taxa MQ4 = 1% sobre o respectivo valor.

4 - O pescado fresco que entre por via marítima e que não seja transaccionado ou avaliado em lota, mas por venda por contrato, estará sujeito ao pagamento da taxa MQ5, equivalente a 1% do respectivo valor.
...
1 - Pelo uso de equipamento na movimentação de contentores são devidas taxas de embarque, desembarque e baldeação (transhipment).
...
1 - Por cada operação completa de pesagem avulsa (tara + carga) é devida a seguinte importância:
...
###### Artigo 28.º — Reparação de estragos
...
###### Artigo 29.º — Tarifa de fornecimentos
...
4 - Pelo fornecimento de aguada a navios em fundeadouro é devida a taxa unitária EE22 = 1000$00/m3, sujeita a um fornecimento mínimo EE23 = 50 m3.
