...
2 - O 2.º sorteio de números de cada concurso do EUROMILHÕES, denominado «Sorteio B», efetua-se mediante a extração de 2 bolas, de uma esfera contendo 12 bolas homogéneas, iguais em material, volume e peso, numeradas de 1 a 12.
...
9 - Sempre que se realizem os sorteios adicionais referidos no n.º 17 do artigo 10.º, o direito a prémios do EUROMILHÕES e do sorteio adicional caduca decorridos 90 dias sobre a data da realização do respetivo sorteio adicional.
...
6 - Sempre que se realizem os sorteios adicionais referidos no n.º 17 do artigo 10.º os prazos referidos no número anterior contam-se a partir da data da realização do respetivo sorteio adicional.
