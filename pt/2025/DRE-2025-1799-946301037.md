---
title: "Edital n.º 1799/2025 — Abertura de concurso documental e internacional para recrutamento de um professor adjunto em regime de contrato de…"
identifier: "DRE-2025-1799-946301037"
country: "pt"
rank: "edital"
...
pdf_url: "https://files.diariodarepublica.pt/2s/2025/11/222000000/0011800123.pdf"
summary: "Abertura de concurso documental e internacional para recrutamento de dois professores coordenadores em regime de contrato de trabalho em funções públicas por tempo indeterminado, na área científica especializada de Enfermagem de Reabilitação."
short_title: "Abertura de concurso documental e internacional para recrutamento de um…"
designation: "Abertura de concurso documental e internacional para recrutamento de um professor adjunto em regime de contrato de trabalho em funções públicas por tempo indeterminado, na área científica especializada de Enfermagem de Reabilitação"
official_number: "1799/2025"
...
6 - Requisitos de admissão ao concurso: São requisitos de admissão ao concurso os candidatos serem detentores do grau de Doutor em Enfermagem ou do Título de Especialista em Enfermagem (nos termos previstos no Decreto-Lei n.º 206/2009, de 31 de agosto, na sua redação atual), obtido há mais de cinco anos, na área científica especializada para que é aberto o concurso.
...
a) Publicação de pelo menos 7 artigos científicos, sendo que 3 publicados nos últimos 5 anos em revista indexada na Scopus ou Web of Science onde seja o primeiro autor ou último autor, na área científica especializada em que é aberto o concurso.
...
b) Orientação de pelo menos 4 trabalhos finais de Mestrado, concluídos ou orientação/coorientação de pelo menos um estudante de doutoramento em enfermagem com registo definitivo de tese.
...
b) Projeto científico e pedagógico que o candidato se propõe desenvolver na área científica especializada de Enfermagem de Reabilitação para que é aberto o concurso conforme previsto no n.º 2 artigo 7.º do Regulamento com uma ponderação de 10 %;
...
8.3 - A avaliação curricular dos vários candidatos em cada um dos parâmetros deve ter em consideração a área científica especializada de Enfermagem de Reabilitação para que é aberto o concurso.

Os critérios a ter em consideração em avaliação do Curriculum Vitae dos candidatos em cada um dos parâmetros enunciados no ponto 8.2. e a ponderação a atribuir em cada um deles na classificação final são os que a seguir se discriminam:
...
v) Coordenação/regência de unidades curriculares - (20 %).
...
iii) Participação em atividades de gestão em instituições de ensino superior, de investigação ou de saúde ou em outras entidades de carácter científico, tecnológico ou cultural que desenvolvam atividades relevantes no âmbito da missão das anteriores - (15 %).
...
viii) Experiência não académica relevante para a área científica especializada de Enfermagem de Reabilitação - (10 %).

8.4 - O Projeto Científico e Pedagógico referido em b. do ponto 8.1. deverá ser formulado nos seguintes termos:

i) Máximo de cinco mil palavras.

ii) Apresentar uma proposta de investigação concisa e uma estratégia para a formação na área científica especializada de Enfermagem de Reabilitação, evidenciando o carácter inovador do projeto e sua relação com a Missão e Visão da ESEL. O aspeto científico deve estar relacionado com a componente pedagógica que o candidato pretende implementar.
...
8.5 - Concluída a fase de verificação dos requisitos de mérito absoluto cabe, nos termos do n.º 1 do art. 23.º do Regulamento, a cada membro do júri produzir um documento escrito, anexo à ata da respetiva reunião, com a classificação final obtida para cada candidato devidamente fundamentada com base nos critérios e parâmetros de avaliação e correspondentes fatores de ponderação constantes dos pontos 8.1, a 8.4 supra.
...
8.7 - Concluída a aplicação do método de seriação previsto nos números anteriores, o júri procede à elaboração de uma lista de ordenação final dos candidatos.
...
8.9 - A lista de ordenação final depois de homologada é publicada na 2.ª série do Diário da República, afixada nos locais de estilo da ESEL e disponibilizada no portal de recrutamento respetivo.
...
11.1 - A candidatura deve ser instruída com o preenchimento do Formulário de Requerimento disponível na plataforma de recrutamento em https://recrutamento.esel.pt/ e ainda com os seguintes documentos em suporte digital e em formato não editável, sendo aconselhada a atribuição de nomes curtos aos ficheiros:
...
Presidente: Doutora Maria da Graça de Melo e Silva, Vice-Presidente da ESEL.
