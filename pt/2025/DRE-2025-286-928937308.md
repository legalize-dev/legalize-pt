...
O sistema de incentivos «Instrumento Financeiro para a Inovação e Competitividade» tem como âmbito de aplicação todas as regiões do território continental com o seguinte enquadramento específico ao nível da tipologia de operação:

a) A tipologia de operação da linha «Reindustrializar» tem aplicação em todas as regiões NUTS II de Portugal Continental no que respeita a grandes empresas, e regiões NUTS II de Grande Lisboa, península de Setúbal e Algarve no que respeita às PME;

b) As tipologias de operação da linha «Economia de Defesa e Segurança» e linha «IA nas PME» têm aplicação em todas as regiões NUTS II de Portugal Continental, para empresas com dimensão PME.
