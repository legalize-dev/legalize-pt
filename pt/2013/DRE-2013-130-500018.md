...
i) Recusa pelos operadores económicos de apresentação de documentação e informação ou de acesso às suas instalações às autoridades de fiscalização;
...
v) Aposição de qualquer outra marcação que prejudique a visibilidade e a legibilidade da marcação CE.
