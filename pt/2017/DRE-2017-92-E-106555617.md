...
4 - A prescrição de dispositivos médicos para apoio a doentes com incontinência ou retenção urinária inclui obrigatoriamente a marca e modelo do dispositivo médico, selecionado de entre os disponíveis, podendo em alguns casos ser feita apenas por indicação do grupo referido no Anexo I à presente portaria.
