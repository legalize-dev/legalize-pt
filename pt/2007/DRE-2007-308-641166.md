...
6 - O disposto no número anterior não prejudica a aplicação das restantes regras de determinação do rendimento da categoria B previstas no CIRS, no âmbito do regime simplificado.
...
10 - Aos jovens candidatos em regime de coabitação é aplicável o disposto nos números anteriores sobre os rendimentos de todos os jovens, com as necessárias adaptações.
