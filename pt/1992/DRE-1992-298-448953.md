...
a) A receção e transmissão, por conta de clientes, de ordens relativas a um ou mais instrumentos financeiros referidos no n.º 3.º;
...
7 - As instituições de crédito devem apresentar ao Banco de Portugal um relatório anual com a descrição dos meios referidos no n.º 1 e com indicação sumária das participações recebidas e do respectivo processamento.
