...
6 - A aplicação das coimas compete à entidade prevista no respectivo regime regulador sectorial ou, caso não exista, à Comissão de Aplicação das Coimas em Matéria Económica e de Publicidade (CACMEP).
...
c) 10 % para a entidade prevista no respectivo regime regulador sectorial ou, caso não exista, para a CACMEP.
